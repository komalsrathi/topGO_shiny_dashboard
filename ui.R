...
dashboardPage(
  ...
  dashboardSidebar(width = 500,
                   ...
                   fluidRow(
                     column(4, radioButtons(inputId = 'cutoff', label = 'Selection', 
                                            choices = c('Upregulated'='pos','
                                                        Downregulated'='neg',
                                                        'Both'='both'))),
                     br(),
                   ...
                   fluidRow(
                     ...
                     column(5, selectInput(inputId = 'genome', label='Chip',
                                           choices=c('Mouse Gene 1.0'='mogene10sttranscriptcluster.db',
                                                     'Mouse Gene 2.0'='mogene20sttranscriptcluster.db',
                                                     'Human Gene 1.0'='hugene10sttranscriptcluster.db',
                                                     'Human Gene 1.1'='hugene11sttranscriptcluster.db',
  ...
  dashboardBody(
    ...
    tabsetPanel(type="tabs", id = "tabvalue",
                ...
                tabPanel(title = "Help Page", value='tab10', 
                         h4("1. Upload list of",strong("Projects."),"The project list opens in the", strong("Project List"), "tab. Each row is a project with LIMMA output and E(xpression)set.",br(),br(),
                            "2. When you select a project, the corresponding", strong("LIMMA"), "output opens in the", strong("Input Table"),"tab.",br(),br(),
                            ...
                            "13. Finally, you can do pathway analysis of your foreground genes by clicking on",strong("Run SPIA")," under the",strong("Pathway Enrichment"), "tab.",
